            ...
            <div className="w-full max-w-md space-y-8 rounded-xl bg-gray-800 p-8 shadow-2xl border border-gray-700">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        {view === 'sign-in' ? 'Sign in to your account' : 'Sign up for a new account'}
                    </p>
                </div>

                {error && (
                    <div className="rounded-md bg-red-900/50 p-4 text-sm text-red-200 border border-red-500/50">
                        {error}
                    </div>
                )}
                ...
                <div className="space-y-4">
                    <button
                        ...
                        disabled={loading}
                        className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-sm font-semibold text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 transition-all"
                    >
                        {loading ? (
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#24292F] px-4 py-3 text-sm font-semibold text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 transition-all border border-gray-600"
                    >
                        {loading ? (
